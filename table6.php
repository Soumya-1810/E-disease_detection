  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#">Animal_doctor<span class="sr-only">(current)</span></a>
      </li>
<li class="nav-item">
        <a class="nav-link" href="animal_doctor.php">User's View</a>
      </li>
       <li class="nav-item">
 ...
 <div class="container">
  <h2><center><u> Animal_doctor EDITABLE DATABASE TABLE</u></center></h2><br>
  <table class="table">
 <thead>
      <tr>
     <th><u>ID</u></th>
...
$sql = "SELECT * FROM search_doctor_animal ";
            ...
            echo "<tr>";
                ...
                echo "<td>" . $row['ADDRESS'] . "</td>";
                 echo "<td>" . $row['DOCTORS_PHONE_NO'] . "</td>";
                  echo "<td><b><a href='update_doctor_animal.php?ID=".$row['ID']."'>UPDATE</a></b></td>";
                   echo "<td><a href='delete6.php?ID=".$row['ID']."'>DELETE</a></td>";
...
$sql = "INSERT INTO search_doctor_animal(DOCTORS_NAME, DOCTOR_SPECIALITY,ADDRESS,DOCTORS_PHONE_NO,image) VALUES ('$d_name','$d_spec','$d_address','$d_phone','$img')";
