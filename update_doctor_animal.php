...
$id=$_GET['ID'];
$sql="select * from search_doctor_animal where ID='$id'";
...
{          $dis_id=$_POST["id"];
          ...
          $aa22=$_POST["address"];
          $aa33=$_POST["phone"];
          $update="update search_doctor_animal set DOCTORS_NAME='$bno',DOCTOR_SPECIALITY='$aa11',ADDRESS='$aa22', DOCTORS_PHONE_NO='$aa33' where ID='$dis_id'";
