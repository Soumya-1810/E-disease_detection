...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#">plant_disease<span class="sr-only">(current)</span></a>
      </li>
 <li class="nav-item">
        <a class="nav-link" href="Plant_disease.php">User's View</a>
      </li>
       <li class="nav-item">
 ...
 <div class="container">
  <h2><center><u> PLANT_DISEASE EDITABLE DATABASE TABLE</u></center></h2><br>
  <table class="table">
 <thead>
      <tr>
     <th><u>ID</u></th>
            ...
            echo "<tr>";
                ...
                echo "<td>" . $row['symptom3'] . "</td>";
                 echo "<td>" . $row['d_name'] . "</td>";
                  echo "<td>" . $row['Cure'] . "</td>";
                 echo "<td><a href='update2.php?d_id=".$row['d_id']."'>UPDATE</a></td>";
                   echo "<td><td><a href='delete2.php?d_id=".$row['d_id']."'>DELETE</a></td></td>";
