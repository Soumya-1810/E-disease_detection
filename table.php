  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#">human_disease<span class="sr-only">(current)</span></a>
      </li>
    
      <li class="nav-item">
        <a class="nav-link" href="table2.php">PLANT_DISEASE</a>
      </li>

       <li class="nav-item">
        <a class="nav-link" href="table3.php">ANIMAL_DISEASE</a>
      </li>

       <li class="nav-item">
        <a class="nav-link" href="table4.php">HUMAN_DOCTOR</a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="table5.php">PLANT_DOCTOR</a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="table6.php">ANIMAL_DOCTOR</a>
      </li>
        <li class="nav-item">
        <a class="nav-link" href="Search_disease.php">User's View</a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="feedback.php">FEEDBACK</a>
      </li>
    </ul>
    <a class="button" href="home.php"><font color="grey">LOGOUT</font></a>
  </div>
</nav><br><br>

 <div class="container">
  <h2><center><u>HUMAN_DISEASE EDITABLE DATABASE TABLE</u></center></h2><br>
  <table class="table">
 <thead>
      <tr>
      <th><u>ID</u></th>
            ...
            echo "<tr>";
                ...
                echo "<td>" . $row['symptom3'] . "</td>";
                 echo "<td>" . $row['d_name'] . "</td>";
                  echo "<td>" . $row['Cure'] . "</td>";
                  echo "<td><a href='update1.php?d_id=".$row['d_id']."'>UPDATE</a></td>";
                   echo "<td><td><a href='delete.php?d_id=".$row['d_id']."'>DELETE</a></td></td>";
