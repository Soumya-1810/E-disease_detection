...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="animal_doctor.php">VIEW Doctor</a>
      </li>
      <li class="nav-item">
...
<form action="" method="post">
 <div1 class="dd">
  ...
  <?php
  $get_symptoms="select * from animal_disease";
...
if(isset($_POST['submit']))
{
  ...
  if($s1=="wrong"||$s2=="wrong"||$s3=="wrong")
  {
    ...
    echo "<script>window.open('Animal_disease.php','_self')</script>";
  }
  
  $select_disease="select * from animal_disease where symptom1='$s1' AND symptom2='$s2' AND symptom3='$s3'";
