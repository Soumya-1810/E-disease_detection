...
@-webkit-keyframes glow {
  ...
  to {
    text-shadow: 0 0 20px grey, 0 0 30px grey, 0 0 40px grey, 0 0 50px grey, 0 0 60px grey, 0 0 70px grey, 0 0 80px grey;
  }
}
</style>
</head>
<body>
   <a class="button" href="Animal_disease.php"><font color="grey">LOGOUT</font></a>

<h1 class="glow"><u>doctor details</u></h1>
<h3 class="glow"><u>Hover over the image below for doctor details:</u></h3>
<h2><u>PET CARE'S:-</u></h2>
<section id="team">
  <div class="container">
    <div class="grid">
      <!-- #str heroes -->
      ...
      include 'db_connection.php';
             $conn = OpenCon();
             $symptoms="select * from search_doctor_animal ";
