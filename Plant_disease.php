...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="plant_doctor.php">VIEW Doctor</a>
      </li>
      <li class="nav-item">
...
<form action="" method="post">
 <div1 class="dd">
  ...
  <?php
  $get_symptoms="select * from plant_disease";
...
if(isset($_POST['submit']))
{
  ...
  $select_disease="select * from plant_disease where symptom1='$s1' AND symptom2='$s2' AND symptom3='$s3'";
