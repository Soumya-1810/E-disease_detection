...
@-webkit-keyframes glow {
  from {
    text-shadow: 0 0 10px black, 0 0 20px black, 0 0 30px #e60073, 0 0 40px #e60073, 0 0 50px #e60073, 0 0 60px #e60073, 0 0 70px #e60073;
  }
...
<body>
   <a class="button" href="Search_disease.php"><font color="grey">LOGOUT</font></a>
  ...
  <div class="container">
    <div class="grid">
      ...
      include 'db_connection.php';
             $conn = OpenCon();
             $symptoms="select * from search_doctor ";
