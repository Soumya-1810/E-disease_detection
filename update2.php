...
$sql = "SELECT symptom1, symptom2, symptom3, d_name, Cure FROM plant_disease WHERE d_id=?";
...
{          $dis_id=$_POST["id"];
          ...
          $aa33=$_POST["dname"];
          $aa44=$_POST["cure"];
          $sql="UPDATE plant_disease SET symptom1='$bno', symptom2='$aa11', symptom3='$aa22', d_name='$aa33', Cure='$aa44' WHERE d_id='$dis_id'";
